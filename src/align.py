...
def main(
    ...
    while True:
        ...
        disp_vis = cv2.flip(vis, 1) if mirror else vis
        disp_aligned = cv2.flip(last_aligned, 1) if mirror else last_aligned

        _safe_imshow("align - camera", disp_vis)
        _safe_imshow("align - aligned", disp_aligned)
        cv2.moveWindow("align - camera", 50, 50)
        cv2.moveWindow("align - aligned", 750, 50)
